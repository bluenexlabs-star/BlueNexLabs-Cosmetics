  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-4 text-slate-600 leading-7">
        All of our cosmetic and face additives are sourced from rigorously
        vetted suppliers. We prioritize quality, transparency, and reliability
        across the supply chain — and we will publish batch documentation here
        as the catalog launches.
      </p>
      ...
      <p className="mt-4 text-slate-600 leading-7">
        ...
        well-documented cosmetic and face additives.
      </p>
      ...
      <ComingSoon title="Batch documents coming soon">
        Certificates and additive documentation will be listed here with the
        first catalog drop — not before.
      </ComingSoon>
    </div>
  );
}
